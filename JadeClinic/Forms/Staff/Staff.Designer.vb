...
Partial Class Staff
    ...
    Private Sub InitializeComponent()
        ...
        btnDiscount.FillColor = Color.FromArgb(CByte(238), CByte(188), CByte(27))
        btnDiscount.HoverState.FillColor = Color.FromArgb(CByte(223), CByte(175), CByte(22))
        btnDiscount.PressedColor = Color.FromArgb(CByte(190), CByte(154), CByte(48))
