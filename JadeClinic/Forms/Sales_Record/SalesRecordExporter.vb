                                                                                            ...
                                                                                            column.Item().PaddingTop(12).Border(2).BorderColor(Colors.Orange.Medium).Background(Colors.Grey.Lighten5).Padding(10).Column(Sub(summary)
                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                             summary.Item().PaddingTop(4).Row(Sub(sRow)
                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                  sRow.RelativeItem().Column(Sub(right)
                                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                                 right.Item().Text($"Expected Amount (Capital + Sales): ₱{expectedAmount:N2}").FontSize(9).SemiBold().FontColor(Colors.Green.Darken2)
                                                                                                                                                                                                                                                                                             End Sub)
                                                                                                                                                                                                                                                              End Sub)
                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                             summary.Item().PaddingTop(8).Row(Sub(pmRow)
                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                  pmRow.RelativeItem().Text($"Other Methods: ₱{otherPaymentAmount:N2}").FontSize(9).SemiBold().FontColor(Colors.Grey.Darken2)
                                                                                                                                                                                                                                                              End Sub)
                                                                                                                                                                                                                         End Sub)
