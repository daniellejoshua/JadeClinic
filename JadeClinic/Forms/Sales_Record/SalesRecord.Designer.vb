...
Partial Class SalesRecord
    ...
    Private Sub InitializeComponent()
        ...
        LabelTitle.Size = New Size(217, 50)
        LabelTitle.TabIndex = 0
        LabelTitle.Text = "Sales Records"
        ' 
        ' DashboardPanel
        ' 
        ...
        DashboardPanel.FillColor = Color.FromArgb(CByte(250), CByte(250), CByte(249))
        DashboardPanel.Location = New Point(-10, 0)
        ...
        Guna2CirclePictureBox5.Location = New Point(1753, 20)
        ...
        Guna2DataGridView1.ThemeStyle.AlternatingRowsStyle.BackColor = Color.FromArgb(CByte(250), CByte(249), CByte(246))
        ...
        Guna2DataGridView1.ThemeStyle.GridColor = Color.FromArgb(CByte(220), CByte(220), CByte(220))
        Guna2DataGridView1.ThemeStyle.HeaderStyle.BackColor = Color.FromArgb(CByte(250), CByte(249), CByte(246))
        Guna2DataGridView1.ThemeStyle.HeaderStyle.BorderStyle = DataGridViewHeaderBorderStyle.None
        Guna2DataGridView1.ThemeStyle.HeaderStyle.Font = New Font("Microsoft Sans Serif", 10.5F, FontStyle.Bold)
        ...
        Guna2DataGridView1.ThemeStyle.RowsStyle.Font = New Font("Poppins", 9F)
        ...
        lblUsername.Location = New Point(1790, 20)
        ...
        SortBy.FocusedColor = Color.FromArgb(CByte(254), CByte(191), CByte(16))
        SortBy.FocusedState.BorderColor = Color.FromArgb(CByte(254), CByte(191), CByte(16))
